...
.. seealso::
    ...
    already enabled by default). For example, the 
    :doc:`datastore extension <../datastore>`, 
    :doc:`multilingual extension <../multilingual>`, and 
    :doc:`stats extension <../stats>` 
    are all core extensions, and the 
    :doc:`data viewer <../data-viewer>` 
    also uses core extensions to enable data previews for different file formats.
