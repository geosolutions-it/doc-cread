...
:doc:`../../install/install_ckan` before continuing.
...
.. literalinclude:: code/plugin_v1.py
...
When you :doc:`install CKAN <../../install/install_ckan>`, you create a
...
.. topic:: Plugin interfaces
   ...
   plugin interfaces that plugins must
...
.. literalinclude:: code/plugin_v2.py
...
.. literalinclude:: code/plugin_v3.py
...
:func:`~ckan.plugins.toolkit.get_action`, see api-reference.
...
.. literalinclude:: code/plugin_v4.py
    :start-after: # Get a list of the members of the 'curators' group.
    :end-before: # 'members' is a list of (user_id, object_type, capacity) tuples, we're
