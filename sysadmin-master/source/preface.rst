...
This document provides information about the C-READ project software. 

It will explain how to administer the various applications that belong to the project, in particular:
...
All the software used in the C-READ project is release under open source licences.    
Namely:
