...
This tutorial assumes that we have CKAN running on the paster development server at http://localhost:5000, 
and that we are using the API key of a sysadmin user.
...
.. literalinclude:: code/iconf_plugin_v1.py
...
To do so, we will extend the CKAN core template as described in the theming documentation.
